...
export default function Footer() {
    return (
        <footer className="footer p-10 bg-base-200 items-center justify-around rounded-box">
            <aside>
                <Image
                ...
                <p>
                    Rigelec S.R.L.
                    <br />
                    Las Heras Nº 331, E3200 - Concordia, Entre Ríos
                </p>
            </aside>
            <nav>
                <header className="footer-title">Social</header>
                <div className="grid grid-flow-col gap-4">
                    <Link href="https://www.linkedin.com/company/rigelec-s-r-l/">
                        <svg
                    ...
                    <Link href="https://www.instagram.com/rigelecsrl/">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="30"
                            height="30"
