        ...
        <div className="modal-box w-4/5">
          <>
            <div className="space-y-2">
              <h3 className="font-bold text-lg">¿Sos instalador?</h3>
              <p className="text-sm">
                Inicia sesión para acceder a tu perfil, podrás publicitarte de
                manera gratuita en nuestro sitio web y llegar a más clientes.
              </p>
            </div>
            <form
